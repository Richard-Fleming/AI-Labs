	...
	m_exitGame{ false } //when true game will exit
{
	...
	m_seeker.m_position.x = m_window.getSize().x - m_seeker.m_shape.getScale().x;
	m_seeker.m_position.y = m_window.getSize().y / 2;
}
...
{
	m_player.update(m_window, t_deltaTime);
...
void Game::render()
{
	...
	m_window.draw(m_seeker.m_shape);
	m_window.display();
}
